...
clearIcon.addEventListener('click', function() {
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        // const premiumTab = document.querySelector(".get-premium-button");
        // const premiumButton = premiumTab.querySelector("button");
        ...
        // Function to toggle the side panel and adjust widths
         function toggleSidePanel() {
            ...
            if (isSidePanelOpen) {
                ...
                // premiumButton.style.padding = "6px 7px 7px 7px";
                ...
                // premiumButton.style.padding = "6px -5px 7px -5px";
